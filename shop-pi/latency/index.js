// via https://github.com/RisingStack/example-http-timings
'use strict'
...
setInterval(function(){
  request(Object.assign(url.parse('https://google.com'), {
    headers: {
      'User-Agent': 'Example'
    }
  }), (err, res) => {
    var str = '';
    for (var key in res.timings){
      str += 'internet,latency=' + key + ' value=' + res.timings[key] + '\n';
    }
